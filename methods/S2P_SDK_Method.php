...
abstract class S2P_SDK_Method extends S2P_SDK_Module
{
     ...
     *
     * @return array|bool Array with keys that can be found in notification body and data structure details as value or false if a notification structure is not expected
     */
