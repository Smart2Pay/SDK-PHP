...
System will ensure all csv files are UTF-8 encoded, that's why you will see `{lang}-utf8.csv` files (e.g. `en-utf8.csv`). These files are UTF-8 encoded version of your original csv file.
