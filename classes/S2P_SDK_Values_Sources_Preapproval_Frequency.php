...
{
    public const FREQ_ONETIME = 'onetime', FREQ_DAILY = 'daily', FREQ_WEEKLY = 'weekly', FREQ_MONTHLY = 'monthly';

    private static $FREQ_ARR = [
    ...
    {
        if (empty($freq)
         || !($freqs_arr = self::get_frequencies()) || empty($freqs_arr[$freq])) {
            return false;
        }
